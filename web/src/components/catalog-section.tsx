          ...
          <aside className="surface-card shadow-card flex h-fit flex-col gap-2 rounded-[var(--radius-card)] border border-white/15 bg-[color:var(--color-neutral-100)]/55 p-3 text-[10px] lg:sticky lg:top-28 lg:max-h-[calc(100vh-7rem)] lg:min-w-0 lg:overflow-y-auto">
            <div className="flex flex-col gap-2">
              ...
              <input
                ...
                className="rounded-[var(--radius-control)] border border-white/20 bg-black/35 px-2 py-1.5 text-xs text-[color:var(--color-text-body)] outline-none focus:border-[color:var(--color-accent-highlight)]"
              />
            </div>
            ...
            <div className="flex flex-col gap-2">
              ...
              <select
                ...
                className="rounded-[var(--radius-control)] border border-white/20 bg-black/35 px-2 py-1.5 text-xs text-[color:var(--color-text-body)]"
              >
