      ...
      >
        {card.imageUrl ? (
          <Image
            ...
            alt={card.name}
            fill
            sizes="(max-width: 768px) 85vw, (max-width: 1280px) 32vw, 22vw"
...
function CatalogSkeleton() {
  return (
    <div className="absolute inset-0 grid place-items-center bg-[color:var(--color-neutral-100)]/55">
      <div className="grid w-full max-w-[1200px] gap-5" style={{ gridTemplateColumns: "repeat(auto-fit, minmax(360px, 1fr))" }}>
